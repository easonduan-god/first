 ...
 * @param:
 */
public class EmpAttenddayQuartz{
	/**
	 * 日常考勤单id
	 */
    ...
    /**
     * 考勤结果 0正常 1迟到 2早退 3旷工 4异常 5迟到+早退
     */
	...
	public SysUserQuartz getUser() {
		return user;
	}

	public void setUser(SysUserQuartz user) {
		this.user = user;
	}
