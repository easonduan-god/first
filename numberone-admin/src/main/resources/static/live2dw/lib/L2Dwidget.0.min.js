        ...
        t.exports = {
            hitokotoVariable: function() {
                return new Promise(function(t) {
                    ...
                    if(hitokotoJson.length!=0){
                        t( hitokotoJson[randomNum(0,90)].hitokoto );
                    }else{
                        var e = new XMLHttpRequest;
                        e.open("get", "/live2dw/assets/hitokoto.json"),
                        e.setRequestHeader("Cache-Control", "no-cache"),
                        e.onreadystatechange = function() {
                            if (4 === e.readyState) {
                                var i = JSON.parse(e.responseText);
                                hitokotoJson = JSON.parse(e.responseText);
                                t( i[randomNum(0,90)].hitokoto );
                            };
                        }
                        ,
                        e.send();
