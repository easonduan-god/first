...
public class AsyncFactory
{
     ...
     * @throws
     */
    public static TimerTask deleteAttendTemp(final String attendBillTempId)
    {
    	return new TimerTask()
    	{
    		@Override
    		public void run()
    		{
				...
				public void run() {
					//删除存到临时表中数据
					try {
						Long row = attendBillService.deleteAttendBillTempAndLeavedayTemp(attendBillTempId);
						if(row>=1){
