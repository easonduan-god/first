...
public class FileUploadUtils
{
    ...
    public static final String upload(String baseDir, MultipartFile file) throws IOException
    {
        try
        {
            return upload(baseDir, file, FileUploadUtils.getExtname(file));
        }
        catch (Exception e)
        {
            throw new IOException(e.getMessage(), e);
     ...
     * @throws IOException
     */
    public static final String uploadAllType(String baseDir, MultipartFile file) throws IOException
    {
    	try
    	{
